...
namespace SynteraERP.Api.Migrations
{
    ...
    [Migration("20260613064218_ItemMasterV2_PricingSeparation")]
    partial class ItemMasterV2_PricingSeparation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.NumberingConfig", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("741c818e-c941-45b7-9818-649af35dca06"),
                            DocType = "QUOTATION",
                            LastNumber = 148,
                            Prefix = "Q.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 13, 6, 42, 16, 354, DateTimeKind.Unspecified).AddTicks(6629), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("33b684ad-2bc5-484f-8169-25f7fc8d3fbe"),
                            DocType = "SALES_ORDER",
                            LastNumber = 48,
                            Prefix = "SO.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 13, 6, 42, 16, 354, DateTimeKind.Unspecified).AddTicks(6659), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("6b29b503-7817-4ae8-b1dd-a1e6c0f883c9"),
                            DocType = "INVOICE",
                            LastNumber = 64,
                            Prefix = "INV.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 13, 6, 42, 16, 354, DateTimeKind.Unspecified).AddTicks(6665), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("10f4900d-0d6b-462f-92ea-2d6b6f4ebe19"),
                            DocType = "PURCHASE_REQUEST",
                            LastNumber = 34,
                            Prefix = "PR.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 13, 6, 42, 16, 354, DateTimeKind.Unspecified).AddTicks(6671), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("7ebbb1d6-e6c1-4e75-9a67-02a25c879e40"),
                            DocType = "PURCHASE_ORDER",
                            LastNumber = 19,
                            Prefix = "PO.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 13, 6, 42, 16, 354, DateTimeKind.Unspecified).AddTicks(6677), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 13, 6, 42, 16, 354, DateTimeKind.Unspecified).AddTicks(6146), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Full system access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 13, 6, 42, 16, 354, DateTimeKind.Unspecified).AddTicks(6149), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 13, 6, 42, 16, 354, DateTimeKind.Unspecified).AddTicks(6159), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Quotation and sales module access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Sales",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 13, 6, 42, 16, 354, DateTimeKind.Unspecified).AddTicks(6161), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 13, 6, 42, 16, 354, DateTimeKind.Unspecified).AddTicks(6168), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Invoice and payment access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Finance",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 13, 6, 42, 16, 354, DateTimeKind.Unspecified).AddTicks(6169), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 13, 6, 42, 16, 354, DateTimeKind.Unspecified).AddTicks(6555), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 13, 6, 42, 16, 354, DateTimeKind.Unspecified).AddTicks(6557), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });

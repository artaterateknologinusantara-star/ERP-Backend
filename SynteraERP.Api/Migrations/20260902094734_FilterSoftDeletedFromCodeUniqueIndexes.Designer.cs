...
namespace SynteraERP.Api.Migrations
{
    ...
    [Migration("20260902094734_FilterSoftDeletedFromCodeUniqueIndexes")]
    partial class FilterSoftDeletedFromCodeUniqueIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 9, 2, 9, 47, 34, 102, DateTimeKind.Unspecified).AddTicks(9320), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Full system access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 2, 9, 47, 34, 102, DateTimeKind.Unspecified).AddTicks(9320), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 9, 2, 9, 47, 34, 102, DateTimeKind.Unspecified).AddTicks(9380), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            RoleId = new Guid("10000000-0000-0000-0000-000000000001"),
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 2, 9, 47, 34, 102, DateTimeKind.Unspecified).AddTicks(9380), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });

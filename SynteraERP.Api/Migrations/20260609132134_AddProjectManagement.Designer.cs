...
namespace SynteraERP.Api.Migrations
{
    ...
    [Migration("20260609132134_AddProjectManagement")]
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.NumberingConfig", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("25770d7c-e4ff-4902-be8d-9ac7cafd36e9"),
                            DocType = "QUOTATION",
                            LastNumber = 148,
                            Prefix = "Q.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 21, 32, 623, DateTimeKind.Unspecified).AddTicks(8617), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("29fd0ef0-b533-46ed-9557-d2f1222ff483"),
                            DocType = "SALES_ORDER",
                            LastNumber = 48,
                            Prefix = "SO.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 21, 32, 623, DateTimeKind.Unspecified).AddTicks(8626), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("8837dbc6-19bf-498b-80cd-17cae1ba58e2"),
                            DocType = "INVOICE",
                            LastNumber = 64,
                            Prefix = "INV.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 21, 32, 623, DateTimeKind.Unspecified).AddTicks(8632), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("1e250bbc-7878-4e59-8085-680dbe5e85c9"),
                            DocType = "PURCHASE_REQUEST",
                            LastNumber = 34,
                            Prefix = "PR.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 21, 32, 623, DateTimeKind.Unspecified).AddTicks(8647), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("ac55121a-2563-46c7-9697-4fe456e8394c"),
                            DocType = "PURCHASE_ORDER",
                            LastNumber = 19,
                            Prefix = "PO.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 21, 32, 623, DateTimeKind.Unspecified).AddTicks(8653), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 21, 32, 623, DateTimeKind.Unspecified).AddTicks(8067), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Full system access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 21, 32, 623, DateTimeKind.Unspecified).AddTicks(8069), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 21, 32, 623, DateTimeKind.Unspecified).AddTicks(8080), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Quotation and sales module access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Sales",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 21, 32, 623, DateTimeKind.Unspecified).AddTicks(8081), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 21, 32, 623, DateTimeKind.Unspecified).AddTicks(8108), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Invoice and payment access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Finance",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 21, 32, 623, DateTimeKind.Unspecified).AddTicks(8109), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 21, 32, 623, DateTimeKind.Unspecified).AddTicks(8545), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 21, 32, 623, DateTimeKind.Unspecified).AddTicks(8547), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });

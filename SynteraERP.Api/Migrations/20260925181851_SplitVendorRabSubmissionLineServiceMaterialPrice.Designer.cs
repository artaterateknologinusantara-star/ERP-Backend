...
namespace SynteraERP.Api.Migrations
{
    ...
    [Migration("20260925181851_SplitVendorRabSubmissionLineServiceMaterialPrice")]
    partial class SplitVendorRabSubmissionLineServiceMaterialPrice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.BankStatementImport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.BankStatementLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.Invoice", b =>
                {
                    ...
                    b.Property<Guid?>("SalesOrderTerminId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.Project", b =>
                {
                    ...
                    b.Property<decimal>("OverbilledBalance")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("UnbilledRevenueBalance")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.ProjectRevenueRecognition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("CumulativeRevenueRecognized")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("IncrementalRevenueThisEntry")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.QuotationGroup", b =>
                {
                    ...
                    b.Property<string>("RecapUnit")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<decimal?>("RecapVolume")
                        .HasPrecision(12, 4)
                        .HasColumnType("decimal(12,4)");
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.QuotationTermin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("QuotationTermins");
                });

            modelBuilder.Entity("SynteraERP.Api.Models.QuotationWorkDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("QuotationWorkDetails");
                });

            modelBuilder.Entity("SynteraERP.Api.Models.QuotationWorkDetailAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("WorkDetailId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("WorkDetailId");

                    b.ToTable("QuotationWorkDetailAttachments");
                });

            modelBuilder.Entity("SynteraERP.Api.Models.QuotationWorkItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 9, 25, 18, 18, 51, 356, DateTimeKind.Unspecified).AddTicks(1430), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Full system access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 25, 18, 18, 51, 356, DateTimeKind.Unspecified).AddTicks(1430), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 9, 25, 18, 18, 51, 356, DateTimeKind.Unspecified).AddTicks(1440), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Quotation and sales module access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Sales",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 25, 18, 18, 51, 356, DateTimeKind.Unspecified).AddTicks(1440), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 9, 25, 18, 18, 51, 356, DateTimeKind.Unspecified).AddTicks(1450), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Invoice and payment access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Finance",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 25, 18, 18, 51, 356, DateTimeKind.Unspecified).AddTicks(1450), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.SalesOrderTermin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 9, 25, 18, 18, 51, 356, DateTimeKind.Unspecified).AddTicks(1520), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            RoleId = new Guid("10000000-0000-0000-0000-000000000001"),
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 25, 18, 18, 51, 356, DateTimeKind.Unspecified).AddTicks(1520), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.BankStatementLine", b =>
                {
                    b.HasOne("SynteraERP.Api.Models.Account", null)
                        .WithMany()
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SynteraERP.Api.Models.BankStatementImport", "Import")
                        .WithMany("Lines")
                        .HasForeignKey("BankStatementImportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SynteraERP.Api.Models.JournalEntryLine", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.Invoice", b =>
                {
                    ...
                    b.HasOne("SynteraERP.Api.Models.SalesOrderTermin", "SalesOrderTermin")
                        .WithMany()
                        .HasForeignKey("SalesOrderTerminId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.QuotationWorkDetail", b =>
                {
                    b.HasOne("SynteraERP.Api.Models.QuotationWorkItem", "WorkItem")
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.QuotationWorkDetailAttachment", b =>
                {
                    b.HasOne("SynteraERP.Api.Models.QuotationWorkDetail", "WorkDetail")
                        .WithMany("Attachments")
                        .HasForeignKey("WorkDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

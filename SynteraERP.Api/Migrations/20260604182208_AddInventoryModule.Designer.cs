...
namespace SynteraERP.Api.Migrations
{
    ...
    [Migration("20260604182208_AddInventoryModule")]
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.NumberingConfig", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6f1f53a9-eae6-489f-bb22-649f2e4118e4"),
                            DocType = "QUOTATION",
                            LastNumber = 148,
                            Prefix = "Q.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 4, 18, 22, 8, 149, DateTimeKind.Unspecified).AddTicks(3239), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("c4654160-176f-4485-a801-6c53c4642f77"),
                            DocType = "SALES_ORDER",
                            LastNumber = 48,
                            Prefix = "SO.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 4, 18, 22, 8, 149, DateTimeKind.Unspecified).AddTicks(3244), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("eac0a728-13a9-437f-8a7e-687676fba37e"),
                            DocType = "INVOICE",
                            LastNumber = 64,
                            Prefix = "INV.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 4, 18, 22, 8, 149, DateTimeKind.Unspecified).AddTicks(3256), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("be6f5372-fdbf-4028-ae23-e50b654ecf36"),
                            DocType = "PURCHASE_REQUEST",
                            LastNumber = 34,
                            Prefix = "PR.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 4, 18, 22, 8, 149, DateTimeKind.Unspecified).AddTicks(3259), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("223e5e3d-0b75-404a-a7cb-9955737c3ec6"),
                            DocType = "PURCHASE_ORDER",
                            LastNumber = 19,
                            Prefix = "PO.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 4, 18, 22, 8, 149, DateTimeKind.Unspecified).AddTicks(3261), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 4, 18, 22, 8, 149, DateTimeKind.Unspecified).AddTicks(3044), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Full system access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 4, 18, 22, 8, 149, DateTimeKind.Unspecified).AddTicks(3046), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 4, 18, 22, 8, 149, DateTimeKind.Unspecified).AddTicks(3049), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Quotation and sales module access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Sales",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 4, 18, 22, 8, 149, DateTimeKind.Unspecified).AddTicks(3049), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 4, 18, 22, 8, 149, DateTimeKind.Unspecified).AddTicks(3052), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Invoice and payment access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Finance",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 4, 18, 22, 8, 149, DateTimeKind.Unspecified).AddTicks(3052), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 4, 18, 22, 8, 149, DateTimeKind.Unspecified).AddTicks(3216), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 4, 18, 22, 8, 149, DateTimeKind.Unspecified).AddTicks(3217), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });

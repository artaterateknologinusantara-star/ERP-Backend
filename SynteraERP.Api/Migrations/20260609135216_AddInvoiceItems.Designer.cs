...
namespace SynteraERP.Api.Migrations
{
    ...
    [Migration("20260609135216_AddInvoiceItems")]
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.NumberingConfig", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2ab1473b-0db2-4680-b13f-9a32a247b6dd"),
                            DocType = "QUOTATION",
                            LastNumber = 148,
                            Prefix = "Q.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 52, 15, 224, DateTimeKind.Unspecified).AddTicks(3879), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("395c93f7-13ad-4604-9333-b8eee67c4f10"),
                            DocType = "SALES_ORDER",
                            LastNumber = 48,
                            Prefix = "SO.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 52, 15, 224, DateTimeKind.Unspecified).AddTicks(3894), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("ad7dde08-077f-42b2-8cd7-679f4182f133"),
                            DocType = "INVOICE",
                            LastNumber = 64,
                            Prefix = "INV.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 52, 15, 224, DateTimeKind.Unspecified).AddTicks(3897), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("9632834a-8713-4f23-8c6b-9147149ad603"),
                            DocType = "PURCHASE_REQUEST",
                            LastNumber = 34,
                            Prefix = "PR.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 52, 15, 224, DateTimeKind.Unspecified).AddTicks(3940), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("3334ec80-ec23-4915-9a25-b42f789e9c15"),
                            DocType = "PURCHASE_ORDER",
                            LastNumber = 19,
                            Prefix = "PO.SYN",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 52, 15, 224, DateTimeKind.Unspecified).AddTicks(3943), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 52, 15, 224, DateTimeKind.Unspecified).AddTicks(3584), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Full system access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 52, 15, 224, DateTimeKind.Unspecified).AddTicks(3585), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 52, 15, 224, DateTimeKind.Unspecified).AddTicks(3590), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Quotation and sales module access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Sales",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 52, 15, 224, DateTimeKind.Unspecified).AddTicks(3591), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 52, 15, 224, DateTimeKind.Unspecified).AddTicks(3594), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Invoice and payment access",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Finance",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 52, 15, 224, DateTimeKind.Unspecified).AddTicks(3595), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("SynteraERP.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 52, 15, 224, DateTimeKind.Unspecified).AddTicks(3832), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 9, 13, 52, 15, 224, DateTimeKind.Unspecified).AddTicks(3833), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
